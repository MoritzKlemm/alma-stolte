            ...
            <Row>
                <Col md={12}>
                    <Form>
                        ...
                        <Form.Group controlId="formBasicEmail">
                            <StyledFormControl type="number" placeholder="Telefon" />
                        </Form.Group>
                        <Form.Group controlId="formBasicEmail">
                            <StyledFormControl type="text" placeholder="Betreff" />
                        </Form.Group>

                        <Form.Group controlId="formBasicEmail" className="align-items-start" css={css`align-items: start;`}>
                            <StyledFormControlMessage type="text" placeholder="Nachricht" />
                        </Form.Group>
